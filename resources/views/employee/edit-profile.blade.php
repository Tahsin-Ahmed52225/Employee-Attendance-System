                ...
                <div class="row ">
                    ...
                    <div class="col-md-4 col-sm-12 ">
                        ...
                        <div class="card card-custom  my-auto">
                            ...
                            <div class="card-body">
                                <!--begin::User-->
                                <form method="POST" action="{{ route('employee.change_profile_image') }}"
                        ...
                        <div class="card card-custom  my-auto pt-4" id="account_info">
                            ...
                            <div class="card-header py-5">
                                <div class="card-title w-100 justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{ route('admin.profile') }}"> <button type="button"
                                                class="btn btn-sm btn-light ">Back to Profile</button> </a>
                            ...
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form id="profile_update_form" class="form" method="POST"
                                accept="{{ route('admin.edit_profile') }}">
                                @csrf
                                <div class="card-body">
                                    <!--begin::Form Group-->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div>
                                                <input name="user_name" class="form-control form-control-lg " type="text"
                                                    value="{{ $user->name }}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg input-group-solid">
                                                ...
                                                <input type="text" class="form-control form-control-lg form-control-solid"
                                                    style="color:#c3c3c3" name="user_mail" value="{{ $user->email }}"
                                                    disabled />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg input-group-solid">
                                                ...
                                                <input name="user_number" type="text"
                                                    ...
                                                    style="background: white; border:#E4E6EF 1px solid;"
                                                    value="{{ $user->number }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg ">
                                                <input type="text" class="form-control form-control-lg form-control-solid"
                                                    style="color:#c3c3c3  border:#E4E6EF 1px solid;"
