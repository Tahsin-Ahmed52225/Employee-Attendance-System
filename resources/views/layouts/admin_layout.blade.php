...
<body id="kt_body"
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="{{ route('admin.view_timesheet') }}"
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="{{ route('admin.leave_request') }}"
                                                ...
                                                <span class="menu-text">App : Leave Request
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="{{ route('admin.leave_list') }}" class="menu-link menu-toggle">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">App : View Leavelist</span>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Home Office</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="{{ route('admin.ho_request') }}" class="menu-link menu-toggle">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="{{ route('admin.ho_list') }}" class="menu-link menu-toggle">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">App : View HOlist</span>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Daily Update</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="{{ route('admin.daily_report') }}"
                                                ...
                                                <span class="menu-text">App : Global Channel</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="{{ route('admin.office_holidays') }}"
                                                class="menu-link menu-toggle">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Add Office Holiday</span>
                                            </a>
                                        </li>
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="{{ route('admin.view_office_holidays') }}"
                                                class="menu-link menu-toggle">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">View Office Holidays</span>
                                            </a>
                                        </li>
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url('{{ Auth::user()->image == null? asset('./files/profile_pics/pp.jpg'): asset('files/profile_pics/' . Auth::user()->image) }}  ')">
                    </div>
            ...
            <div>
                <!--begin:Heading-->
                <h5 class="mb-5">Additional Option</h5>
                <!--end:Heading-->
                <!--begin::Item-->
                <div class="d-flex align-items-center bg-light-warning rounded p-5 gutter-b">
                    <span class="mr-5">
                        ...
                        <i class="flaticon-cogwheel-1 text-primary "></i>
                        <!--end::Svg Icon-->

                    </span>
                    <div class="d-flex flex-column flex-grow-1 mr-2">
                        <a href="{{ route('admin.settings') }}"
                            class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">System
                            Settings</a>
                        <span class="text-muted font-size-sm">All system settings</span>
                    </div>
    ...
    <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
        ...
        <div class="offcanvas-content px-10">
            <div class="tab-content">
                ...
                <!--begin::Tabpane-->
                <div class="tab-pane fade show pt-2 pr-5 mr-n5 active" id="kt_quick_panel_notifications"
                    role="tabpanel">
                    <!--begin::Nav-->
